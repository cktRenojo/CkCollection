...
import { collection, onSnapshot, addDoc, deleteDoc, doc, updateDoc, getDoc, serverTimestamp } from 'firebase/firestore';
...
interface ProductsContextType {
  products: Product[];
  addProduct: (productData: Omit<Product, 'id' | 'images' | 'createdAt'>, imageFile: File | null) => Promise<void>;
...
export const ProductsProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addProduct = async (productData: Omit<Product, 'id' | 'images' | 'createdAt'>, imageFile: File | null) => {
    const finalProductData: Omit<Product, 'id'> = {
        ...
        ...(productData.genderCategory && { genderCategory: productData.genderCategory }),
    };
